...
ages_csv <- read_csv(here::here("Practice Activities", "Week 2", "Ages_Data", "ages.csv"))
...
ages_tab <- read_tsv(here::here("Practice Activities", "Week 2", "Ages_Data", "ages_tab.txt"))
...
ages_mystery <- read_delim(here::here("Practice Activities", "Week 2", "Ages_Data", "ages_mystery.txt"), delim = "|")
...
ages_excel <- read_excel(here::here("Practice Activities", "Week 2", "Ages_Data", "ages.xlsx"))
...
ages_factors <- read_csv(here::here("Practice Activities", "Week 2", "Ages_Data", "ages.csv"), col_types = cols(
  Name = col_factor(),
  Age = col_character()
))
